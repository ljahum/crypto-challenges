...
from random import choice, getrandbits as rand
...
def gen_inc_list(size, tmp=5): # 背包密码生成
...
if __name__ == '__main__':
    ...
    pickle.dump({'cip': cip, 'pbkey': pbkey}, open('enc2.pickle', 'wb'))
