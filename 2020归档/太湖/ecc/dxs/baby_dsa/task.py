...
print(pubkey)  # p, q, g, y = pubkey
# ------------------------------------------------------------
message1 = urandom(16).encode('hex')
signature1 = sign(message1, pubkey, privkey)  # return r, s

print(message1,signature1) # m r s
print(verify(message1, signature1, pubkey)) # ture
# ---------------------------------------------------------
