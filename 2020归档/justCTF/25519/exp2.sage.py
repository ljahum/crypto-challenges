...
_sage_const_2 = Integer(2); _sage_const_255 = Integer(255); _sage_const_19 = Integer(19); _sage_const_0 = Integer(0); _sage_const_486662 = Integer(486662); _sage_const_1 = Integer(1); _sage_const_9 = Integer(9); _sage_const_10001 = Integer(10001); _sage_const_8 = Integer(8); _sage_const_1024 = Integer(1024)
...
while wins < _sage_const_8 :
    ...
    print(I.xy()[_sage_const_0 ])
    print(I.xy()[_sage_const_1 ])
    input()
    print(conn.recvuntil('>'))
    conn.sendline('1')
...
print(conn.recvuntil('>'))
conn.sendline('3')
print(conn.recv(_sage_const_1024 ))
