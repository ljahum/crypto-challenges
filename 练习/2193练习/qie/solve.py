...
if __name__ == '__main__':
    ...
    # Y2FuIHlvdYBmaW5kp21lPyEh
    secret_key = b'can you\x80find\xa7me?!!'
    QQ = QQ_TEA()
    ...
    # print(Bytes2Hex(enc))
    # 91E036DFEA42E64C690134BEA488E2709C373CA603774B8C41A5F17B23D38A3824C858A6E928C3EB
    enc = 0x91E036DFEA42E64C690134BEA488E2709C373CA603774B8C41A5F17B23D38A3824C858A6E928C3EB
    
    enc = long_to_bytes(enc)
    dec = QQ.decrypt(enc)
    print(dec)
# flag{d0nt_t0uch_my_tea!} 
