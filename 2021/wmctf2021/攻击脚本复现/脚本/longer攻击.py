...
# M = Block(b'a'*(length - 1) * 16) + Block.len(16) + Block(b'1'*15)

N = Block(b'a'*16)

M = Block(b'b'*16) + Block.len(16) + Block(b'c'*15)

C,T = encrypt(N,M)
ic(C.data.hex())
ic(T.data.hex())

M = Block(b'b'*16) + Block.len(16) + Block(b'c'*15+b'\01')

# dd0085a86adbe5b4d420cbc94ef14541
# ========================
S = Block.zero()
C_ = Block()
T_ = M[1 + 1] ^ C[1 + 1]
...
Encryption Oracle
--------------------
[+] send nonce = 00000000000000000000000000000000
[+] send plain = 61616161616161616161616161616161616161616161616161616161616161610000000000000000000000000000008031313131313131313131313131313101
[+] get cipher = dd29887d691a5211bfbfb07257f548e25da223220c71948dee1fcb83bd650a6a029b1bcdcf95a233091e89a5219398d9dc7da35385b4ff2854d877c59e3e6d29
[+] get tag = 4577c78ab19dad7a7499c0863dca0fde

--------------------
Decryption Oracle
--------------------
[+] send nonce = 00000000000000000000000000000000
[+] send cipher = dd29887d691a5211bfbfb07257f548e25da223220c71948dee1fcb83bd650a6a029b1bcdcf95a233091e89a521939859
[+] send tag = ed4c9262b485ce1965e946f4af0f5c28
[+] get auth = True
[+] get plain = 6161616161616161616161616161616161616161616161616161616161616161374a5ea77c5161dc4267d2ce51a15879
'''